...
- サーバー: `C:\Users\rento\GitHub\raythm-server\server`
- クライアント: `C:\Users\rento\GitHub\raythm`
...
- サーバーのローカル検証は `C:\Users\rento\GitHub\raythm-server\server` で実行する。
...
- デプロイ後は `docker compose ps` と `curl -fsS http://localhost:3000/health` で稼働確認する。
