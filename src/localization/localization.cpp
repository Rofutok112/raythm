...
constexpr literal_translation kLiteralTranslations[] = {
    ...
    {"Global Rating", "グローバルレート"},
    {"RATING", "レート"},
    {"RATE", "レート"},
    {"UNRATED", "未評価"},
    {"BEST PLAYS", "ベスト"},
    {"No rated players", "レート対象プレイヤーはいません"},
    {"No rated players.", "レート対象プレイヤーはいません。"},
    {"No rated players yet.", "レート対象プレイヤーはまだいません。"},
    {"Open to load rankings.", "開くとランキングを読み込みます。"},
    {"Loading rankings...", "ランキングを読み込み中..."},
    {"Failed to load rating rankings.", "レートランキングを読み込めませんでした。"},
    {"Prev", "前へ"},
    {"Next", "次へ"},
    {"Close", "閉じる"},
    {"Refresh", "更新"},
    ...
    {"Refreshing...", "更新中..."},
    {"Loading...", "読み込み中..."},
    {"Initializing audio...", "オーディオを初期化中..."},
    {"Loading local catalog...", "ローカルカタログを読み込み中..."},
    {"Preparing local catalog...", "ローカルカタログを準備中..."},
    {"Checking local catalog cache...", "ローカルカタログキャッシュを確認中..."},
    {"Checking catalog cache signature...", "カタログキャッシュ署名を確認中..."},
    {"Opening catalog cache...", "カタログキャッシュを開いています..."},
    {"Checking catalog cache version...", "カタログキャッシュのバージョンを確認中..."},
    {"Reading cached songs...", "キャッシュ済み曲を読み込み中..."},
    {"Reading cached charts...", "キャッシュ済み譜面を読み込み中..."},
    {"Preparing cached catalog...", "キャッシュ済みカタログを準備中..."},
    {"Cached catalog read.", "キャッシュ済みカタログを読み込みました。"},
    {"Reading saved chart offsets...", "保存済み譜面オフセットを読み込み中..."},
    {"Validating cached catalog...", "キャッシュ済みカタログを検証中..."},
    {"Sorting cached catalog...", "キャッシュ済みカタログを並べ替え中..."},
    {"Refreshing repaired catalog cache...", "修復したカタログキャッシュを更新中..."},
    {"Catalog cache ready.", "カタログキャッシュを準備しました。"},
    {"Using cached catalog...", "キャッシュ済みカタログを使用中..."},
    {"Reading saved chart settings...", "保存済み譜面設定を読み込み中..."},
    {"Reading online content links...", "オンラインコンテンツ連携を読み込み中..."},
    {"Cleaning old content cache...", "古いコンテンツキャッシュを整理中..."},
    {"Scanning local songs...", "ローカル曲をスキャン中..."},
    {"Scanning downloaded songs...", "ダウンロード済み曲をスキャン中..."},
    {"Sorting catalog...", "カタログを並べ替え中..."},
    {"Saving catalog cache...", "カタログキャッシュを保存中..."},
    {"Local catalog ready.", "ローカルカタログを準備しました。"},
    {"Preparing UI text...", "UI テキストを準備中..."},
    {"Preparing scoring cache...", "スコア計算キャッシュを準備中..."},
    {"Catalog loaded with warnings.", "警告付きでカタログを読み込みました。"},
    {"Preparing play session...", "プレイセッションを準備中..."},
    {"Finding playable songs...", "プレイ可能な曲を検索中..."},
    {"Preparing hitsounds...", "ヒット音を準備中..."},
    {"Loading selected chart...", "選択した譜面を読み込み中..."},
    {"Preparing chart timing...", "譜面タイミングを準備中..."},
    {"Loading audio...", "音声を読み込み中..."},
    {"Preloading hitsounds...", "ヒット音を先読み中..."},
    {"Analyzing waveform...", "波形を解析中..."},
    {"Detecting song lead-in...", "曲の開始位置を検出中..."},
    {"Preparing notes...", "ノーツを準備中..."},
    {"Starting...", "開始中..."},
    ...
    {"Server maintenance", "サーバーメンテナンス中"},
    {"Online features are temporarily unavailable. Please try again later.",
     "オンライン機能は一時的に利用できません。しばらくしてから再試行してください。"},
    {"Tried: ", "接続先: "},
