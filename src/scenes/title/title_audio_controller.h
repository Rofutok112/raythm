...
struct title_preview_snapshot {
    song_select::preview_audio_loader::snapshot audio;
    song_select::jacket_loader::snapshot jacket;
    bool playing = false;
...
public:
    ...
    void update(title_audio_policy::hub_mode mode,
    ...
    void request_preview_audio(const song_select::selection_key& key, const song_select::song_entry* song);
    void request_preview_jacket(const song_select::selection_key& key, const song_select::song_entry* song);
    void resume_preview_song(const song_select::song_entry* song);
    void resume_preview_song(const song_select::selection_key& key, const song_select::song_entry* song);
    void pause_preview();
    void stop_preview();
    void toggle_preview_song(const song_select::song_entry* song);
    void toggle_preview_song(const song_select::selection_key& key, const song_select::song_entry* song);
